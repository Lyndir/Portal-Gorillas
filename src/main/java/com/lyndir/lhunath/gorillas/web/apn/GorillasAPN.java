...
import com.lyndir.lhunath.ipos.notifier.APNServerConfig;
 ...
 * @author lhunath
 */
public class GorillasAPN {

    private static final Logger logger        = Logger.get( GorillasAPN.class );
    ...
    public GorillasAPN()
        ...
        apnClient = new APNClient( keyStore, PRIV_KEY_PASS, APNServerConfig.LOCAL );
        apnClient.start();
    }
    ...
    public static void main(String[] args)
        ...
        GorillasAPN gorillasAPN = new GorillasAPN();
        gorillasAPN.send();
